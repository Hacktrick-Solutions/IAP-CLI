####### ========================================== #######
# Title:  Google Cloud Internet Access Proxy CLI
# Author: Ricky Elsum
# Language: Powershell
####### ========================================== #######
...
#6 Notification Scheduler Postgres
...
#7 Production SQL Studio Manager MS SQL Server 2019
...
#8 Development SQL Studio Manager MS SQL Server 2019
$host8 = 'dev-us' # Change to set your Google Compute Engine VM's You need to connect to
$zone8 = 'us-central1-a' # Change to suit the Zone your Compute Engine Resides In
$port8 = $Remote_MSSQL_Port

#9 Development SQL Studio Manager MS SQL Server 2019
